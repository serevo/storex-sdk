...
STOCK-MAN アプリ (開発コードネーム: Storex [^1]) 用モジュールの開発 SDK です。
...
[^1]: 各種ファイル名やパッケージ名、ソースコードの他、GitHub 等の開発者用向けサービスやリソースのURL にも使用しています。
...
- インターフェイスに対してはメンバの追加を含む一切の変更は破壊的変更となります。
